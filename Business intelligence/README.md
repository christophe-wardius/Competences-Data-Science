<h1>Compétences Business Intelligence</h1>
<h2>1. Analyses NLP français dans Power BI</h2>
...
<li>Analyses NLP en Python (usage de spaCy & NLTK).</li>
<li>Spécificités NLP en français (usage du modèle spaCy dédié & TextBlob-fr)</li>
